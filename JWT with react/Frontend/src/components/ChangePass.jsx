            ...
            <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg">
                ...
                <form onSubmit={handleChangePass}>
                    <div className="mb-4">
                        ...
                        <input type="text" name="oldPass" placeholder="Enter old password" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600" required onChange={handleChange} />
                    </div>
                    <div className="mb-4">
                    ...
                    <button type="submit" className="w-full cursor-pointer bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 transition" >Update Password</button>
                </form>
            </div>
        </div>
    )
